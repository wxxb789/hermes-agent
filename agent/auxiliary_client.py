...
from agent.copilot_url import is_copilot_base_url
...
def _to_async_client(sync_client, model: str, is_vision: bool = False):
    ...
    elif is_copilot_base_url(sync_base_url):
    ...
    if provider == "custom":
        if explicit_base_url:
            ...
            if base_url_host_matches(custom_base, "api.kimi.com"):
                extra["default_headers"] = {"User-Agent": "claude-code/0.1.0"}
            elif is_copilot_base_url(custom_base):
                from hermes_cli.copilot_auth import copilot_request_headers
...
def auxiliary_max_tokens_param(value: int) -> dict:
    ...
    if (not or_key
            ...
            and (base_url_hostname(custom_base) == "api.openai.com" or is_copilot_base_url(custom_base))):
